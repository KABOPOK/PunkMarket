...
public class HttpSteps {
  ...
  public <T> ResponseEntity<T> sendAuthorizeUserRequest(String url, LoginDataDTO loginData, Class<T> responseType) {
    HttpHeaders headers = new HttpHeaders();
    headers.setContentType(MediaType.APPLICATION_JSON);
    HttpEntity<LoginDataDTO> request = new HttpEntity<>(loginData, headers);
    return testRestTemplate.exchange(url, HttpMethod.POST, request, responseType);
  }
